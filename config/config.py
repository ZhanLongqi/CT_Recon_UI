...
# 配置文件路径（可根据实际路径调整）
CONFIG_PATH = "/home/lonqi/work/CT_Recon_UI/config/app_config.yaml"
...
MAX_IMAGE_INDEX = cfg['projection']['max_image_index']  # 滑块最大索引值
...
my_data = {
    'raw_folder_path': cfg['data']['raw_folder_path'],
